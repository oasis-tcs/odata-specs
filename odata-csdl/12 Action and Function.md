...
::: {.varjson .example}
Example ##ex: a function with one overload returning the top-selling products for a given
year.
```json
"TopSellingProducts": [
  {
...
::: {.varxml .example}
Example ##ex: a function overload returning the top-selling products for a given
year.
```xml
