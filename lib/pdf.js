...
module.exports = async function (name, _variant, meta, force) {
  ...
  if (force) {
    ...
    await page.pdf({
      ...
      headerTemplate: `<div style="font-family: LiberationSans, Arial, Helvetica, sans-serif; font-size: 10px; width: 100%; text-align: center;">Standards Track Work Product</div>`,
      footerTemplate: `<div style="font-family: LiberationSans, Arial, Helvetica, sans-serif; font-size: 8px; width: 90%; margin: auto; margin-top: 40px; display:flex; flex-flow:row wrap;">
