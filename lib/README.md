...
- [`npm run zip <yyyy-MM-dd>`](zip.js) creates ZIP files for OASIS public review of document with the given publication date. The ZIP files are written into the [`zip`](../zip) folder.
