...
[· ]{style="font-family:Symbol"}The bound function call syntax rules
...
[[· ]{style="font-family:Symbol"}]{.Datatype}`Add/subtract duration `
...
Example 88: all employees born in minute 40 of any hour on any day
...
Example 90: all employees born in second 40 of any minute of any hour on
any day
...
Example 98: all `Orders` that have any `Items` with a `Quantity` greater
than `100`
...
Example 100: all categories along with their products used in some order
...
Example 101: all `Orders` that have only `Items` with a `Quantity`
greater than `100`
...
Example 103: collection of string literals
...
Example 105: email addresses ending with `.com` assuming
...
Example 106: customers along with their orders that shipped to the same
...
[· ]{style="font-family:Symbol"}the name of a stream property to include
that stream property,

[· ]{style="font-family:Symbol"}a star (`*`) to expand all navigation
properties of the identified structured instance, optionally followed by
`/$ref` to expand only entity references, or

[· ]{style="font-family:Symbol"}a navigation property to expand the
...
[· ]{style="font-family:Symbol"}an entity-valued instance annotation to
...
[· ]{style="font-family:Symbol"}a path, to include a property,

[· ]{style="font-family:Symbol"}a star (`*`), to include all declared or
dynamic properties of the type, or

[· ]{style="font-family:Symbol"}a qualified schema name followed by a
...
[· ]{style="font-family:Symbol"}the name of a property or
non-entity-valued instance annotation of the identified structured
instance,

[· ]{style="font-family:Symbol"}the qualified name of a bound action,

[· ]{style="font-family:Symbol"}the qualified name of a bound function
