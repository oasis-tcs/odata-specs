...
Here is a customized command line which will generate HTML from this markdown file (named odata-v4.02-csd01-part2-url-conventions.md):

pandoc -f gfm -t html odata-v4.02-csd01-part2-url-conventions.md -c styles/markdown-styles-v1.7.3b.css --toc --toc-depth=5 -s -o odata-v4.02-csd01-part2-url-conventions.html --metadata title="OData Version 4.02. Part 2: URL Conventions"
