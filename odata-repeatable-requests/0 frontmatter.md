...
#### This stage:
https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$stage$$$/$$$filename$$$.md (Authoritative) \
https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$stage$$$/$$$filename$$$.html \
https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$stage$$$/$$$filename$$$.pdf

#### Previous stage:
https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$previousStage$$$/$$$filename$$$-$$$previousStage$$$.docx (Authoritative) \
https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$previousStage$$$/$$$filename$$$-$$$previousStage$$$.html \
https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$previousStage$$$/$$$filename$$$-$$$previousStage$$$.pdf

#### Latest stage:
https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$filename$$$.md (Authoritative) \
https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$filename$$$.html \
https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$filename$$$.pdf
...
_$$$pagetitle$$$_.
Edited by ? and ?. $$$pubdate$$$. OASIS $$$subtitle$$$.
https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$stage$$$/$$$filename$$$.html.
Latest stage: https://docs.oasis-open.org/odata/repeatable-requests/v1.0/$$$filename$$$.html
