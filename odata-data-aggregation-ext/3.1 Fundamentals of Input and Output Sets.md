...
An output set thus consists of instances with different structures. This is the same situation as with a collection of an open type [OData-CSDL, sections "Open Entity Type"]($$$OData-CSDLJSON$$$#OpenEntityType) and ["Open Complex Type"]($$$OData-CSDLJSON$$$#OpenComplexType) and it is handled in the same way.
