...
- [_Aggregate Expression_](:AggregateExpression) – argument of the `aggregate` [transformation](#Transformationaggregate) or [function](#Functionaggregate) defined in [section ##AggregationAlgorithm]
