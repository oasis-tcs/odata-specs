...
Instances in the output set of $\Pi_G(s)$ that contain the key of an entity also retain that entity's applicable control information [#OData-JSON#ControlInformation].
