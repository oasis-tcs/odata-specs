...
type (see [example 50](#implicitcast)).
...
::: example
Example <a name="implicitcast" href="#implicitcast">50</a>: Comparing values of different types
```
'4.0' eq 4
```
...
In the following subsections up to and including [section 5.1.1.12](#ConditionalFunctions)
