...
parameters MUST be represented like parameters in an action invocation [OData-JSON 18](https://docs.oasis-open.org/odata/odata-json-format/v4.02/odata-json-format-v4.02.html#ActionInvocation),
...
if it is written using implicit parameter aliases (see [OData-Protocol 11.5.4.1.1](https://docs.oasis-open.org/odata/odata/v4.02/odata-v4.02-part1-protocol.html#InlineParameterSyntax)).
```
...
Entities are represented as structured literals as described in [OData-JSON 6](https://docs.oasis-open.org/odata/odata-json-format/v4.02/odata-json-format-v4.02.html#Entity).
