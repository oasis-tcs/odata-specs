...
- Using an entity key to select a single
  ...
  If the service cannot determine the canonical collection the canonical collection (as defined in [OData-Protocol, section 10](https://docs.oasis-open.org/odata/odata/v4.02/odata-v4.02-part1-protocol.html#ContextURL))
