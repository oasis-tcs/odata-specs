...
::: example
Example 57: all products with the Name 'Milk' that also have a Price
less than 2.55:
```
...
::: example
Example 58: all products that either have the Name 'Milk' or have a
...
::: example
Example 61: all products whose `name` value is 'Milk' or 'Cheese':
```
