...
Note for TC Editors: we expect to have the permanent TC-specific comment lists properly available in the future, so this clause will change at that time.
