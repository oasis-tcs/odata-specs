...
<!--
Here is a customized command line which will generate HTML from the markdown file (named `odata-csdl-xml-v4.02-csd01.md`). Line breaks are added for readability only:
