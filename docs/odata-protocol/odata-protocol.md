...
Among other possibilities, this is the case if
1. the URL contains the name of an entity set or singleton
2. the URL ends with a containment navigation property, optionally followed by a key predicate
3. the URL ends with a non-containment navigation property with a navigation property binding,
   optionally followed by a key predicate, or
4. the payload includes a context URL.
...
If the URL of an update request falls into case 1 or 2 given above and the request
...
If the URL of an update request does not fall into case 1 or 2 given above, it ends
...
the same as the distinction between update and upsert. If the request
...
::: example
Example <a id="entityWithStreamProperty" href="#entityWithStreamProperty">85</a>: read an entity and select a stream property
...
::: example
Example <a id="batchhost" href="#batchhost">107</a>:
```json
...
::: example
Example <a id="batchRequest" href="#batchRequest">109</a>: a batch request that contains the following individual
...
::: example
Example <a id="batchcontentid" href="#batchcontentid">110</a>: a batch request that contains the following operations in
the order listed:
