...
Non-insertable properties, as well as dependent properties that are tied to
non-key properties of the principal entity, SHOULD be omitted from the request body.
If provided, services MUST either ignore the value in the request body or fail the request.
...
property marked as insertable that cannot currently be inserted by the
user (i.e., given the state of the object or permissions of the authenticated user).
...
Non-updatable properties, as well as dependent properties that are tied to
non-key properties of the principal entity, SHOULD be omitted from the request body.
If provided, services MUST either ignore the value in the request body or fail the request.
...
user (i.e., given the state of the object or permissions of the authenticated user), and
...
Key properties whose value is provided in the request URL SHOULD be omitted from the request body.
