...
non-key properties of the principal entity through a referential constraint,
...
- key properties,
- dependent properties that are tied to non-key properties of the principal entity through a referential constraint,
...
A key properties whose value is provided in the request URL SHOULD be omitted from the request body.
