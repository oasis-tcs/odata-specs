...
[Section ##ReplaceaCollectionofEntities]| Describe semantics for using `continue-on-error` when replacing a collection of entities. | [358](https://github.com/oasis-tcs/odata-specs/issues/358)
