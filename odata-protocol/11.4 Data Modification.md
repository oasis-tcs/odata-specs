...
see for example [OData-JSON #odata-json-format#ControlInformationetagodataetag].
...
- dependent properties that are tied to non-key properties of the principal entity through a referential constraint [OData-CSDL #odata-csdl-json#ReferentialConstraint] (informally: "denormalized" properties),
