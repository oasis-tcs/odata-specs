...
request](#UpdateanEntity) to a valid URL for addressing a single entity [#OData-URL#AddressingEntities]
...
(as defined in [section ##ContextURL]) can be determined for the newly-created entity.
...
payload consisting of an entity reference [#OData-JSON#EntityReference] or use
a bind operation [#OData-JSON#BindOperation].
