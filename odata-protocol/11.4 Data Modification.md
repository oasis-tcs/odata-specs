...
In such a case, the service can determine the canonical collection (as defined in [section ##ContextURL])
...
the service can determine the canonical collection or canonical singleton (as defined in [section ##ContextURL]) for the newly-created entity
through a navigation property path binding [#OData-CSDL#NavigationPropertyPathBinding]
