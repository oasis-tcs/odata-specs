...
If the service is unable to determine the canonical collection (as defined in [section ##ContextURL])
...
canonical collection or canonical singleton (as defined in [section ##ContextURL]) for the newly-created entity,
...
4. matches a navigation property path binding [#OData-CSDL#NavigationPropertyPathBinding]
...
::: example
Example ##ex: `Category` is a single-valued nullable non-containment navigation property
