...
see for example [OData-JSON, section #odata-json-format#ControlInformationetagodataetag].
...
- dependent properties that are tied to non-key properties of the principal entity through a referential constraint [OData-CSDL, section #odata-csdl-json#ReferentialConstraint] (informally: "denormalized" properties),
