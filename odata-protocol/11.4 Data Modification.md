...
- The service MUST reject data modification requests that violate constraints
  ...
  [`Capabilities.InsertRestrictions`]($$$OData-VocCap$$$#InsertRestrictions)).
...
in [section ##ErrorHandlingwhenUpdatingaCollectionofEntities] in cases where this specification
...
[section ##ErrorHandlingwhenUpdatingaCollectionofEntities].
