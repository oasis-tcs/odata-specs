...
- 11.5.4 [Functions](#Functions) and
subsections
...
query options*](#SystemQueryOptions) optionally prefixed with a dollar
...
[`maxpagesize`](#Preferencemaxpagesizeodatamaxpagesiz) preference. The
...
::: example
Example ##ex: return the number of product`s `in the Products entity set
```
...
the [`track-changes`](#Preferencetrackchangesodatatrackchan) preference
...
The [`/$count`](#RequestingtheNumberofItemsinaCollect) segment can be
...
specifies [`track-changes`](#Preferencetrackchangesodatatrackchan) on
...
the [`return` Prefer header](#Preferencereturnrepresentationandret).
...
[creating](#CreateRelatedEntitiesWhenCreatinganE) or
[linking](#LinktoRelatedEntitiesWhenCreatinganE) related entities when
...
[`return`](#Preferencereturnrepresentationandret) preference header. In
...
[`return`](#Preferencereturnrepresentationandret) preference is
specified.
...
entities](#LinktoRelatedEntitiesWhenCreatinganE) as well as content for
[new related entities](#CreateRelatedEntitiesWhenCreatinganE), but MUST
...
header](#Preferencereturnrepresentationandret) with a value of
[`return=minimal`](#Preferencereturnrepresentationandret) and did not
...
[`Prefer` header](#Preferencereturnrepresentationandret) with a value of
[`return=representation`](#Preferencereturnrepresentationandret), or by
...
entities](#RequestingtheMediaStreamofaMediaEnti), single-valued
...
A [media entity](#RequestingtheMediaStreamofaMediaEnti) MUST have a
...
[Prefer header](#Preferencereturnrepresentationandret) with a value of
[`return=minimal`](#Preferencereturnrepresentationandret).
...
[`return=representation`](#Preferencereturnrepresentationandret), in
...
value](#RequestingaPropertysRawValueusingval) of a primitive property
...
header](#Preferencereturnrepresentationandret) with a value of
[`return=representation`](#Preferencereturnrepresentationandret).
...
[`$index`](#RequestinganIndividualMemberofanOrde) MAY be used to specify
...
entity](#UpdateRelatedEntitiesWhenUpdatinganE).
...
regardless of the [`return`](#Preferencereturnrepresentationandret)
...
[`return`](#Preferencereturnrepresentationandret) preference, and MUST
...
[obtained](#AdvertisingAvailableOperationswithin) from a previously
...
is [obtained](#AdvertisingAvailableOperationswithin) from a previously
...
header](#Preferencereturnrepresentationandret).
...
HTTP message, as described in [RFC7230](#HTTPMessage), which is the full
...
::: example
Example ##ex: a batch request that contains the following individual
...
[`continue-on-error`](#Preferencecontinueonerrorodatacontin) preference
...
::: example
Example ##ex: referencing the batch request example 101 above, assume all
...
::: example
Example ##ex: referencing the example 101 above again, assume that
```
...
the [OData 4.0 Advanced Conformance
Level](#OData40AdvancedConformanceLevel) can expect to interoperate with
...
5.1. [`Accept`](#HeaderAccept) (section 8.2.1)

5.2. [`OData-MaxVersion`](#HeaderODataMaxVersion) (section 8.2.7)
...
i\. SHOULD support the [`in`](#BuiltinFilterOperations)` `operator
