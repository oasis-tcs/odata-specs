...
#### This stage:
https://docs.oasis-open.org/odata/odata-temporal-ext/v4.0/$$$stage$$$/$$$filename$$$.md (Authoritative) \
https://docs.oasis-open.org/odata/odata-temporal-ext/v4.0/$$$stage$$$/$$$filename$$$.html \
https://docs.oasis-open.org/odata/odata-temporal-ext/v4.0/$$$stage$$$/$$$filename$$$.pdf

#### Previous stage:
https://docs.oasis-open.org/odata/odata-temporal-ext/v4.0/$$$previousStage$$$/odata-temporal-ext-v4.0-$$$previousStage$$$.docx (Authoritative) \
https://docs.oasis-open.org/odata/odata-temporal-ext/v4.0/$$$previousStage$$$/odata-temporal-ext-v4.0-$$$previousStage$$$.html \
https://docs.oasis-open.org/odata/odata-temporal-ext/v4.0/$$$previousStage$$$/odata-temporal-ext-v4.0-$$$previousStage$$$.pdf
...
* _OData Version 4.02_. Edited by Michael Pizzo, Ralf Handl, and Heiko Theißen. A multi-part Work Product that includes:
  ...
  * _ABNF components: OData ABNF Construction Rules Version 4.02 and OData ABNF Test Cases_. https://docs.oasis-open.org/odata/odata/v4.0/$$$stage$$$/abnf/
