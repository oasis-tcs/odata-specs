...
describe("OASIS doc build", function() {
	it("Markdown assembly", async function() {
		...
		assert.deepStrictEqual(markdown.split(/\r\n|\r|\n/),
			fs.readFileSync(__dirname + "/test.md.txt").toString().split(/\r\n|\r|\n/),
			"Markdown");
	});
